...
document.querySelector("#submit-btn").addEventListener("click", searchFun);

//this edit in case the user press Enter key , it will search       //added 
                ...
                // Elements
                  ...
                  if (type == "movie" || type == "series") {
                    ...
                    function nominate(){
                      ...
                      deleteBtn.style.backgroundColor = "#D11A2A" //changed from red 

                      nomBtn.style.backgroundColor="grey"
                      nomBtn.style.cursor = 'default' //added
                      nomBtn.style.boxShadow = 'none' //added
                    ...
                    function deleteNomination(){
                      ...
                      // nomBtn.style.backgroundColor= '#0d496f'
                      nomBtn.style.backgroundColor="#1677b5" //added
                      nomBtn.style.cursor = 'pointer' //added

                      //these listeners instead of hover in css 
                      nomBtn.addEventListener('mouseover',function(){   //added
                      nomBtn.style.backgroundColor= '#0d496f'
                      nomBtn.style.boxShadow = '0 0 11px rgb(13, 73, 111, 0.7)'
                      })
                      nomBtn.addEventListener('mouseout',function(){  //added
                        nomBtn.style.backgroundColor = '#1677b5'
                        nomBtn.style.boxShadow = 'none'
                        })
